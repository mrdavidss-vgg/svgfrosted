...
(() => {
  ...
  var m = (s, t, r) => {
    r = s != null ? Qe(Ye(s)) : {};
    return tt(t || !s || !s.__esModule ? K(r, "default", {
      value: s,
      enumerable: true
    }) : r, s);
  };
  var f = et((ut, k) => {
    ...
    var X = y && typeof y.apply == "function" ? y.apply : function (t, r, e) {
      return Function.prototype.apply.call(t, r, e);
    };
    var g;
    if (y && typeof y.ownKeys == "function") {
      g = y.ownKeys;
    ...
    function J(s) {
      if (s._maxListeners === undefined) {
        return d.defaultMaxListeners;
      } else {
    ...
    function Y(s, t, r, e) {
      ...
      o = s._events;
      if (o === undefined) {
        o = s._events = Object.create(null);
        s._eventsCount = 0;
      } else {
    ...
    d.prototype.once = function (t, r) {
      P(r);
      this.on(t, Z(this, t, r));
      return this;
    };
    d.prototype.prependOnceListener = function (t, r) {
      P(r);
      this.prependListener(t, Z(this, t, r));
      return this;
    };
    d.prototype.removeListener = function (t, r) {
      ...
      if (e === r || e.listener === r) {
        ...
        if (n.removeListener !== undefined) {
          this.emit("removeListener", t, c || r);
        }
      }
      return this;
    };
    ...
    function ee(s, t, r) {
      ...
      if (n === undefined) {
        ...
        return re(n, n.length);
      }
    }
    d.prototype.listeners = function (t) {
      return ee(this, t, true);
    };
    d.prototype.rawListeners = function (t) {
      return ee(this, t, false);
    };
    d.listenerCount = function (s, t) {
      if (typeof s.listenerCount == "function") {
    ...
    function st(s, t) {
      return new Promise(function (r, e) {
        function n(i) {
          s.removeListener(t, o);
          e(i);
        }
        function o() {
          if (typeof s.removeListener == "function") {
            s.removeListener("error", n);
          }
    ...
    overrideParseFromString() {
      this.ctx.override(this.domProto, "parseFromString", (t, r, e) => {
        ...
        if (i.intercepted) {
          ...
          return i.target.call(i.that, i.data.string, i.data.type);
        }
      });
    }
    overrideQuerySelector() {
      this.ctx.override(this.docProto, "querySelector", (t, r, e) => {
        ...
        if (o.intercepted) {
          ...
          return o.target.call(o.that, o.data.selectors);
        }
      });
    }
    overrideDomain() {
      this.ctx.overrideDescriptor(this.docProto, "domain", {
        ...
        set: (t, r, [e]) => {
          ...
          if (n.intercepted) {
            ...
            return n.target.call(n.that, n.data.value);
          }
        }
      });
    }
    ...
    overrideCreateTreeWalker() {
      this.ctx.override(this.docProto, "createTreeWalker", (t, r, e) => {
        ...
        if (l.intercepted) {
          ...
          return l.target.call(l.that, l.data.root, l.data.show, l.data.filter, l.data.expandEntityReferences);
        }
      });
    }
    overrideWrite() {
      this.ctx.override(this.docProto, "write", (t, r, e) => {
        ...
        if (o.intercepted) {
          ...
          return o.target.apply(o.that, o.data.html);
        }
      });
    ...
    overrideAttribute() {
      this.ctx.override(this.elemProto, "getAttribute", (t, r, e) => {
        ...
        if (o.intercepted) {
          ...
          return o.target.call(o.that, o.data.name);
        }
      });
      this.ctx.override(this.elemProto, "setAttribute", (t, r, e) => {
        ...
        if (i.intercepted) {
          ...
          return i.target.call(i.that, i.data.name, i.data.value);
        }
      });
    ...
    overrideAudio() {
      this.ctx.override(this.window, "Audio", (t, r, e) => {
        ...
        if (o.intercepted) {
          ...
          return new o.target(o.data.url);
        }
      }, true);
    }
    overrideHtml() {
    ...
    overrideInsertAdjacentHTML() {
      this.ctx.override(this.elemProto, "insertAdjacentHTML", (t, r, e) => {
        ...
        if (i.intercepted) {
          ...
          return i.target.call(i.that, i.data.position, i.data.html);
        }
      });
    }
    overrideInsertAdjacentText() {
      this.ctx.override(this.elemProto, "insertAdjacentText", (t, r, e) => {
        ...
        if (i.intercepted) {
          ...
          return i.target.call(i.that, i.data.position, i.data.text);
        }
      });
    }
    hookProperty(t, r, e) {
      ...
      if (this.ctx.nativeMethods.isArray(t)) {
        for (let o of t) {
          this.hookProperty(o, r, e);
        }
        return true;
      }
      let n = t.prototype;
      this.ctx.overrideDescriptor(n, r, e);
      return true;
    }
  };
  var ae = O;
    ...
    overrideAppend() {
      this.ctx.override(this.nodeProto, "append", (t, r, [...e]) => {
        ...
        if (n.intercepted) {
          ...
          return n.target.call(n.that, n.data.nodes);
        }
      });
      this.ctx.override(this.nodeProto, "appendChild", (t, r, e) => {
        ...
        if (o.intercepted) {
          ...
          return o.target.call(o.that, o.data.node);
        }
      });
    }
    overrideBaseURI() {
    ...
    overrideItemMethods() {
      ...
      this.ctx.override(this.attrProto, "getNamedItemNS", (t, r, e) => {
        ...
        if (i.intercepted) {
          ...
          return i.target.call(i.that, i.data.namespace, i.data.localName);
        }
      });
    ...
    overrideFunction() {
      this.ctx.override(this.window, "Function", (t, r, e) => {
        ...
        if (i.intercepted) {
          ...
          return i.target.call(i.that, ...i.data.args, i.data.script);
        }
      }, true);
    }
    overrideToString() {
      this.ctx.override(this.fnProto, "toString", (t, r) => {
        ...
        if (e.intercepted) {
          ...
          return e.target.call(e.data.fn);
        }
      });
    }
  };
      ...
      if (this.fetch) {
        this.ctx.override(this.window, "fetch", (t, r, e) => {
          ...
          if (i.intercepted) {
            ...
            return i.target.call(i.that, i.data.input, i.data.options);
          }
        });
        this.ctx.override(this.window, "Request", (t, r, e) => {
          ...
          if (i.intercepted) {
            ...
            return new i.target(i.data.input, i.data.options);
          }
        }, true);
        return true;
      } else {
  ...
  var V = class extends ye.default {
    ...
    overrideOpen() {
      this.ctx.override(this.xhrProto, "open", (t, r, e) => {
        ...
        let [n, o, i = true, c = null, l = null] = e;
        let u = new a({
          method: n,
          input: o,
          async: i,
        ...
        if (u.intercepted) {
          ...
          return u.target.call(u.that, u.data.method, u.data.input, u.data.async, u.data.user, u.data.password);
        }
      });
    }
    overrideResponseUrl() {
    ...
    overrideSend() {
      this.ctx.override(this.xhrProto, "send", (t, r, [e = null]) => {
        ...
        if (n.intercepted) {
          ...
          return n.target.call(n.that, n.data.body);
        }
      });
    }
    ...
    overrideConstruct() {
      this.ctx.override(this.window, "EventSource", (t, r, e) => {
        ...
        if (i.intercepted) {
          ...
          return new i.target(i.data.url, i.data.config);
        }
      }, true);
    ...
    overridePushState() {
      this.ctx.override(this.historyProto, "pushState", (t, r, e) => {
        ...
        if (c.intercepted) {
          ...
          return c.target.call(c.that, c.data.state, c.data.title, c.data.url);
        }
      });
    }
    ...
    overrideGo() {
      this.ctx.override(this.historyProto, "go", (t, r, [e]) => {
        ...
        if (n.intercepted) {
          ...
          return n.target.call(n.that, n.data.delta);
        }
      });
    }
    overrideForward() {
  ...
  var ke = I;
  var Se = m(f(), 1);
  var T = class extends Se.default {
    constructor(t) {
      super();
      this.ctx = t;
      this.window = t.window;
    ...
    emulate(t, r) {
      ...
      for (let o of n.keys) {
        this.ctx.nativeMethods.defineProperty(e, o, {
          ...
          set: o !== "origin" ? function (i) {
            switch (o) {
              case "href":
                n.location.href = r(i);
                break;
              case "hash":
                n.emit("hashchange", e.href, i.trim().startsWith("#") ? new URL(i.trim(), e.href).href : new URL("#" + i.trim(), e.href).href, n);
                break;
              default:
                {
                  let c = new URL(e.href);
                  c[o] = i;
                  n.location.href = r(c.href);
                }
                break;
            }
          } : undefined,
      ...
      if ("reload" in this.location) {
        this.ctx.nativeMethods.defineProperty(e, "reload", {
          value: this.ctx.wrap(this.location, "reload", (o, i) => o.call(i === e ? this.location : i)),
          writable: false,
          enumerable: true
        });
      }
      ...
      if ("ancestorOrigins" in this.location) {
        this.ctx.nativeMethods.defineProperty(e, "ancestorOrigins", {
          get() {
            let o = [];
            if (n.window.DOMStringList) {
              n.ctx.nativeMethods.setPrototypeOf(o, n.window.DOMStringList.prototype);
            }
            return o;
          },
          set: undefined,
      ...
      if (this.ctx.window.Location) {
        this.ctx.nativeMethods.setPrototypeOf(e, this.ctx.window.Location.prototype);
      }
      return e;
    }
  };
  ...
  var H = class extends Oe.default {
    ...
    overridePostMessage() {
      this.ctx.override(this.window, "postMessage", (t, r, e) => {
        ...
        if (c.intercepted) {
          return c.returnValue;
        } else if (this.ctx.worker) {
          return c.target.call(c.that, c.data.message, c.data.transfer);
        } else {
          return c.target.call(c.that, c.data.message, c.data.origin, c.data.transfer);
        }
      });
    }
    wrapPostMessage(t, r, e = false) {
      return this.ctx.wrap(t, r, (n, o, i) => {
        if (this.ctx.worker ? !i.length : i < 2) {
          return n.apply(o, i);
        }
        let c;
        let l;
        ...
        if (h.intercepted) {
          ...
          return h.target.call(h.that, h.data.message, h.data.transfer);
        } else {
          return h.target.call(h.that, h.data.message, h.data.origin, h.data.transfer);
        }
      });
    }
    ...
    overrideSendBeacon() {
      this.ctx.override(this.navProto, "sendBeacon", (t, r, e) => {
        ...
        if (i.intercepted) {
          ...
          return i.target.call(i.that, i.data.url, i.data.data);
        }
      });
    }
  };
  ...
  var Ne = globalThis.SharedWorker;
  var Re = globalThis.localStorage;
  var ct = globalThis.navigator.serviceWorker;
  var v = MessagePort.prototype.postMessage;
  var Wt = {
    prototype: {
  ...
  async function W() {
    ...
    let t = Promise.race([Promise.any(s), new Promise((r, e) => setTimeout(e, 1000, new TypeError("timeout")))]);
    try {
      return await t;
    } catch (r) {
  ...
  var j = class {
    constructor(t) {
      ...
      if (t instanceof MessagePort || t instanceof Promise) {
        this.port = t;
      } else {
        this.createChannel(t, true);
      }
    }
    createChannel(t, r) {
      if (self.clients) {
    ...
    async sendMessage(t, r) {
      ...
      try {
        ...
        this.createChannel();
        return await this.sendMessage(t, r);
      }
      let e = new MessageChannel();
      let n = [e.port2, ...(r || [])];
      let o = new Promise((i, c) => {
        e.port1.onmessage = l => {
          let u = l.data;
          if (u.type === "error") {
            c(u.error);
        ...
        if (i.type === "fetch") {
          try {
            ...
            await async function (c, l, u) {
              let h = await u.request(new URL(c.fetch.remote), c.fetch.method, c.fetch.body, c.fetch.headers, null);
              if (!lt() && h.body instanceof ReadableStream) {
                let w = new Response(h.body);
                h.body = await w.arrayBuffer();
              }
              if (h.body instanceof ReadableStream || h.body instanceof ArrayBuffer) {
                v.call(l, {
                  type: "fetch",
                  fetch: h
                }, [h.body]);
          ...
          try {
            ...
            await async function (c, l, u) {
              let [h, w] = u.connect(new URL(c.websocket.url), c.websocket.protocols, c.websocket.requestHeaders, p => {
    ...
    overrideAddModule() {
      this.ctx.override(this.workletProto, "addModule", (t, r, e) => {
        ...
        if (i.intercepted) {
          ...
          return i.target.call(i.that, i.data.url, i.data.options);
        }
      });
    }
    overridePostMessage() {
      this.ctx.override(this.workerProto, "postMessage", (t, r, e) => {
        ...
        if (i.intercepted) {
          ...
          return i.target.call(i.that, i.data.message, i.data.transfer);
        }
      });
    }
    overrideImportScripts() {
      this.ctx.override(this.window, "importScripts", (t, r, e) => {
        ...
        if (n.intercepted) {
          ...
          return n.target.apply(n.that, n.data.scripts);
        }
      });
    }
  };
    ...
    overrideObjectURL() {
      this.ctx.override(this.URL, "createObjectURL", (t, r, e) => {
        ...
        if (o.intercepted) {
          ...
          return o.target.call(o.that, o.data.object);
        }
      });
      this.ctx.override(this.URL, "revokeObjectURL", (t, r, e) => {
        ...
        if (o.intercepted) {
          ...
          return o.target.call(o.that, o.data.url);
        }
      });
    }
  };
  ...
  var F = class extends We.default {
    ...
    overrideMethods() {
      ...
      this.ctx.override(this.storeProto, "key", (t, r, e) => {
        ...
        if (o.intercepted) {
          ...
          return o.target.call(o.that, o.data.index);
        }
      });
    }
    overrideLength() {
    ...
    emulate(t, r = {}) {
      ...
      let e = new this.ctx.window.Proxy(r, {
        get: (n, o) => {
          if (o in this.storeProto || typeof o == "symbol") {
            return t[o];
          }
          let i = new a({
            name: o
        ...
        set: (n, o, i) => {
          ...
          if (c.intercepted) {
            ...
            return t[c.data.name] = c.data.value;
          }
        },
        deleteProperty: (n, o) => {
          if (typeof o == "symbol") {
    ...
    overrideSetGetProperty() {
      this.ctx.override(this.cssStyleProto, "getPropertyValue", (t, r, e) => {
        ...
        if (o.intercepted) {
          ...
          return o.target.call(o.that, o.data.property);
        }
      });
      this.ctx.override(this.cssStyleProto, "setProperty", (t, r, e) => {
        ...
        if (i.intercepted) {
          ...
          return i.target.call(i.that, i.data.property, i.data.value);
        }
      });
    }
    overrideCssText() {
    ...
    overrideOpen() {
      this.ctx.override(this.IDBFactory.prototype, "open", (t, r, e) => {
        ...
        if (i.intercepted) {
          ...
          return i.target.call(i.that, i.data.name, i.data.version);
        }
      });
    }
    overrideName() {
  ...
  var $ = class extends Ge.default {
    ...
    overrideWebSocket(t) {
      this.ctx.override(this.window, "WebSocket", (r, e, n) => {
        ...
        let i = h => new Proxy(h, {
          get(w, p) {
            if (p === "isTrusted") {
              ...
              return Reflect.get(w, p);
            }
          }
        });
        let c = t.createWebSocket(n[0], n[1], null, {
        ...
        c.addEventListener("message", async h => {
          ...
          if (typeof w != "string") {
            if ("byteLength" in w) {
              if (l.binaryType === "blob") {
                w = new Blob([w]);
              } else {
                Object.setPrototypeOf(w, ArrayBuffer.prototype);
              }
            } else if ("arrayBuffer" in w && l.binaryType === "arraybuffer") {
      ...
      this.ctx.override(this.wsProto, "send", (r, e, n) => this.socketmap.get(e).barews.send(n[0]), false);
      this.ctx.override(this.wsProto, "close", (r, e, n) => {
        let o = this.socketmap.get(e);
        if (n[0] === undefined) {
          n[0] = 1000;
        }
  ...
  var x = class extends Ke.default {
    ...
    overrideDescriptor(t, r, e = {}) {
      ...
      if (n) {
        this.nativeMethods.defineProperty(t, r, n);
        return n;
      } else {
        return {};
      }
