...
(() => {
  ...
  function p(o) {
    ...
    (a.nativeMethods.defineProperty(e.meta, "base", {
      get() {
        return o.document
          ? (a.node.baseURI.get.call(o.document) !== d &&
              ((d = a.node.baseURI.get.call(o.document)), (P = e.sourceUrl(d))),
            P)
          : e.meta.url.href;
      },
    }),
    ...
    if (
      (a.element.hookProperty(n, "contentWindow", {
    ...
    (a.style.on("setCssText", (t) => {
      ...
      a.websocket.overrideWebSocket(c),
